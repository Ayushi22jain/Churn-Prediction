...
Exploratory Data Analysis (EDA): * Univariate Analysis: Examining the distribution of individual variables.
...
Bash
git clone https://github.com/Ayushi22jain/Churn-Prediction.git
Install the necessary dependencies:

Bash
pip install pandas scikit-learn matplotlib seaborn
Run the ChurnPredictions.ipynb notebook in your preferred environment.
